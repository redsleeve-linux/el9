...
# uppack into a directory called binutils-VERSION not gcc-toolset-13-binutils-VERSION.
...
install_binutils()
{
    ...
    local local_root=%{buildroot}/opt/rh/gcc-toolset-13/root/usr
...
/opt/rh/gcc-toolset-13/root/usr/etc/gprofng.rc
%endif
...
#----------------------------------------------------------------------------
%changelog
* Mon Jan 19 2026 Jacco Ligthart <jacco@redsleeve.org> 2.40-21.1.redsleeve
